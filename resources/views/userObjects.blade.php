...
@section('content')
  <div class="mt-2">
    ...
    <p>Estes são os seus requerimentos. Para criar um novo requerimento, clique em "Novo requerimento, no menu
      superior".<br>
              ...
              <span class="badge bg-{{ $badgeColor }}">
                {{ implode(
                    ...
                    array_map(
                        ...
                        array_keys($workflowObject->state),
                        $workflowObject->state,
                    ),
                ) }}
              </span>
            </td>
