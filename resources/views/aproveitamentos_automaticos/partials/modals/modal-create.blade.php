<button type="button" class="btn btn-sm btn-outline-primary ml-2 js-edit-only" data-toggle="modal"
  data-target="#modalNovaDisciplina">
  <div>
...
<div class="modal fade" id="modalNovaDisciplina" tabindex="-1" aria-labelledby="modalNovaDisciplinaLabel"
  aria-hidden="true">
